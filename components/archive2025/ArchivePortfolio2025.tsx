...
const LAB_ITEMS = [
  {
    title: "Archive",
    tech: "Next.js · React",
    desc: "Six case studies and five interactive demos, hand-engineered in Next.js. The portfolio is also the proof of the work.",
    rdNote: "The portfolio is a design artifact — every decision here ships to production.",
    href: "/archive",
  },
  {
